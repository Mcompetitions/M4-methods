...
M4Subset <- list(NA)
for(i in 1:414){
    M4Subset[[i]] <- M4Full[[48000+23000+24000+359+4227+i]]
}
...
write.csv(matrixForecasts,file="M4HourlyForecasts.csv")
write.csv(matrixLower,file="M4HourlyLower.csv")
write.csv(matrixUpper,file="M4HourlyUpper.csv")
