...
M4Subset <- list(NA)
for(i in 1:359){
    M4Subset[[i]] <- M4Full[[48000+23000+24000+i]]
}
...
write.csv(matrixForecasts,file="M4WeeklyForecasts.csv")
write.csv(matrixLower,file="M4WeeklyLower.csv")
write.csv(matrixUpper,file="M4WeeklyUpper.csv")
