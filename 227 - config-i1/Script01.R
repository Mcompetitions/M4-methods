...
write.csv(matrixForecasts,file="M4YearlyForecasts.csv")
write.csv(matrixLower,file="M4YearlyLower.csv")
write.csv(matrixUpper,file="M4YearlyUpper.csv")
